...
def build_err_msg(arrays, err_msg, header='Records are not equal:',
...
def assert_approx_equal(actual, desired, significant=7, err_msg='',
    ...
    Traceback (most recent call last):
        ...
    AssertionError:
    Records are not equal to 8 significant digits:
     ACTUAL: 1.234567e-21
    ...
    msg = build_err_msg(
        ...
        header='Records are not equal to %d significant digits:' % significant,
        verbose=verbose)
    try:
        # If one of desired/actual is not finite, handle it specially here:
        # check that both are nan if any is a nan, and test for equality
